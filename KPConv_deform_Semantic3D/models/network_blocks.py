...
def assemble_FCNN_blocks(inputs, config, dropout_prob):
    ...
    features = F[-1]
    supervised_features = []
    tmp_features = unary_block(None, None, features, None, 8, config, dropout_prob < 0.99, activation_fn=False)
    ...
    for block_i, block in enumerate(config.architecture[start_i:]):
        ...
        if 'upsample' in block:
            ...
            with tf.variable_scope('se'):
                se_features = unary_block(None, None, features, None, 10, config, dropout_prob < 0.99, activation_fn=False)
...
def segmentation_loss(logits, inputs, batch_average=False):
    ...
    # Exclusive Labels cross entropy on each point
    class_weight = [1.84913437e+08, 8.61334920e+07, 9.74844820e+07, 1.60335971e+08, 3.02954130e+07, 1.58981695e+08, 1.41892990e+07, 7.14909100e+06, 5.54404200e+06]
    #class_weight = [5.70987796e+08, 2.87985501e+08, 2.93568692e+08, 5.28088146e+08, 8.40979160e+07, 5.30654075e+08, 4.80851130e+07, 2.09999220e+07, 1.75779850e+07]
