...
if __name__ == '__main__':
    ...
    os.system('mkdir %s'%(model.saving_path+'/code'))
    os.system('cp %s %s'% ('training_Semantic3D.py', model.saving_path+'/code/'))
    os.system('cp %s %s'% ('utils/trainer.py', model.saving_path+'/code/'))
    os.system('cp %s %s'% ('models/KPFCNN_model.py', model.saving_path+'/code/'))
    os.system('cp %s %s'% ('models/network_blocks.py', model.saving_path+'/code/'))
    os.system('cp %s %s'% ('kernels/convolution_ops.py', model.saving_path+'/code/'))
    os.system('cp %s %s'% ('datasets/Semantic3D.py', model.saving_path+'/code/'))
