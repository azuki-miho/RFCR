...
if __name__ == '__main__':
    ...
    if Mode == 'train':
        ...
        os.system('cp %s %s'%('main_S3DIS.py', model.saving_path + '/code/'))
        os.system('cp %s %s'%('RandLANet.py', model.saving_path + '/code/'))
        os.system('cp %s %s'%('helper_tool.py', model.saving_path + '/code/'))
        os.system('cp %s %s'%('utils/data_prepare_s3dis.py', model.saving_path + '/code/'))
        model.train(dataset)
    elif Mode == 'test':
        cfg.saving = False
        model = Network(dataset, cfg)
